class PickupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pickup.save
        format.html { redirect_to edit_pickup_path(@pickup), notice: 'Pickup was successfully created.' }
        format.json { render :edit, status: :created, location: @pickup }
      else
  ...
  private
    ...
    def pickup_params
      params.require(:pickup).permit(:cd_id, :pickup_title, :pickup_body)
    end
end
