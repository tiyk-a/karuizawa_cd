...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post pickups_url, params: { pickup: { cd_id: @pickup.cd_id, pickup_body: @pickup.pickup_body, pickup_title: @pickup.pickup_title } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { cd_id: @pickup.cd_id, pickup_body: @pickup.pickup_body, pickup_title: @pickup.pickup_title } }
